...
export const GithubButton = () => {
  return (
    ...
    >
      <button
        type="button"
        className="text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 mr-2"
      >
        <svg
...
export const Code: FC<{ children: ReactNode }> = ({ children }) => (
  <code className="p-1 bg-slate-400/30 rounded-md text-sm">{children}</code>
);
