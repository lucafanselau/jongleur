...
But unfortunately, the scene won't be doing anything. We still need a way to provide progress to the clips. This will be tackled on the next page, hang on we are nearly finished...
